...
import { LogOut, LogIn, History, Wand2, Sun, Moon, X } from "lucide-react";
import { useAuth } from "@/lib/auth-context";
import { useTheme } from "@/lib/theme-context";

export default function Navbar() {
  const { user, signInWithGoogle, signOutUser, signInError, clearSignInError } = useAuth();
  ...
  return (
    <>
      ...
      {signInError && (
        ...
        >
          <span style={{ flex: 1 }}>{signInError}</span>
          <button
            ...
            {user ? (
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 600,
                  color: "#000",
                  background: signingIn ? "rgba(34,197,94,0.6)" : "var(--primary)",
                  border: "none",
